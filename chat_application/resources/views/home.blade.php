...
<div class="content-body">
            ...
            <div class="card white bg-info text-center">
                <div class="card-content">
                    <div class="card-body py-3">
                        <img src="{{ asset('app-assets/images/elements/01.png')}}" alt="element 01" width="140" class="float-left">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-md-12 col-sm-12">
            <div class="card border-info text-center bg-transparent">
                <div class="card-content">
                    <img src="{{ asset('app-assets/images/elements/07.png')}}" alt="element 04" width="140" class="float-left mt-3">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-content">
                    <img class="card-img-top img-fluid" src="{{ asset('app-assets/images/carousel/25.jpg')}}" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card text-center">
                <div class="card-content">
                    <img class="card-img-top img-fluid" src="{{ asset('app-assets/images/carousel/24.png')}}" alt="Card image cap">
                    <div class="card-body">
                        <h4>Formal Shoes</h4>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-content">
                    <img class="card-img-top img-fluid" src="{{ asset('app-assets/images/carousel/22.jpg')}}" alt="Card image cap">
                    <div class="card-body">
                        <h4>Sunglass</h4>
                        <p class="card-text">Some quick example text.</p>
                    </div>
