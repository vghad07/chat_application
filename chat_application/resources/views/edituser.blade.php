             ...
             <div class="col-md-8">
                 <div class="card">
                     ...
                     <div class="card-content collapse show">
                         ...
                         <div class="card-body">
                             {{ Form::open(['action' => ['UsersController@update',$user->id],'method'=>'POST','class'=>'form','enctype'=>'multipart/form-data']) }}
                             <div class="form-body">
                                 ...
                                 <div class="row">
                                     <div class="col-md-12">
                                         <div class="form-group">
                                             ...
                                             {{ Form::text('name',$user->name,['class'=>'form-control border-primary','placeholder'=>'Title'])}}
                                         </div>
                                     ...
                                     <div class="col-md-12">
                                         <div class="form-group">
                                             <div class="form-group">
                                                 ...
                                                 {{ Form::text('email',$user->email,['class'=>'form-control border-primary','placeholder'=>'Body'])}}
                                             </div>
                                         </div>
                                     </div>
