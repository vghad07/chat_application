    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="#"><i class="icon-user"></i><span class="menu-title" data-i18n="nav.users.main">Manage Users</span></a></li>
                <li class=" nav-item"><a href="#"><i class="icon-user"></i><span class="menu-title" data-i18n="nav.group.main">Manage Groups</span></a></li>

                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.chat-application.main">Chat Application</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="users-list.html" data-i18n="nav.users.list">Users List</a>
                        </li>
                        <li><a class="menu-item" href="group-list.html" data-i18n="nav.group.list">Group List</a>
                        </li>
                    </ul>
                </li>
             ...
             Template Hide Ends here   -->
                <!-- Page Layout Hide here
